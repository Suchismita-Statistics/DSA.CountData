...
Result comparisons: 
  ...
  Using WAIC: "waic_comp.csv"
  Using DIC: "DIC_comp.csv"
  Using Bayes Factor: "bayes_factor_comp.csv"

If it says model 2 is better, it means the Frailty model, and if it says model 1, then it is the SIR model.
